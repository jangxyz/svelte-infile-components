...
import type { Node as AcornNode, AssignmentExpression, ClassDeclaration, ExportAllDeclaration, ExportDefaultDeclaration, ExportNamedDeclaration, ExportSpecifier, FunctionDeclaration, Identifier, ImportDeclaration, ImportDefaultSpecifier, ImportNamespaceSpecifier, ImportSpecifier, VariableDeclarator, Literal } from 'acorn';
...
export declare function findLocalDeclaredNames(input: string | Program): [string, WithIdIdentifier<VariableDeclarator> | FunctionDeclaration | ClassDeclaration | ImportSpecifier | ImportDefaultSpecifier | ImportNamespaceSpecifier | ExportSpecifier | ExportDefaultDeclaration | AssignmentExpression][];
/**
 ...
 */
export declare function findExportNames(input: string | Program): (readonly [localName: string, exportedName: string | undefined, node: readonly [ExportNamedDeclaration, WithIdIdentifier<VariableDeclarator> | FunctionDeclaration | ClassDeclaration | (ExportSpecifier & {
    local: Identifier;
    exported: Identifier;
})] | readonly [ExportDefaultDeclaration, Identifier | AssignmentExpression | Literal] | readonly [ExportAllDeclaration]])[];
