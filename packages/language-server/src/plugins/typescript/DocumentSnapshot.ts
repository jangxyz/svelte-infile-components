...
export namespace DocumentSnapshot {
  ...
  export function fromDocument(
    ...
    console.log(
      '🚀 ~ file: typescript/DocumentSnapshot.ts:108 ~ DocumentSnapshot.fromDocument:',
      {
        tsxMap,
        htmlAst,
        text,
...
function preprocessSvelteFile(
  ...
  console.log(
    '🚀 ~ file: typescript/DocumentSnapshot.ts:245 ~ preprocessSveltefile:',
    { document, options },
  );
  ...
  try {
    ...
    console.log(
      '🚀 ~ file: typescript/DocumentSnapshot.ts:264 ~ preprocessSveltefile ~ tsx:',
      tsx,
      { text },
    );
