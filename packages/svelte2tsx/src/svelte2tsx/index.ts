...
import { preRecursiveProcess, filename } from './infileComponents';
...
export function svelte2tsx(
  ...
  console.log(
    '🚀 ~ file: svelte2tsx/index.ts:404 ~ svelte2tsx:',
  ...
  console.log(
    '🚀 ~ file: svelte2tsx/index.ts:812 ~ processSvelteTemplate result:',
    filename(options.filename),
    options.filename,
    {
