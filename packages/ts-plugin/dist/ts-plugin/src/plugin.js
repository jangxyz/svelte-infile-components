    ...
    function create(info) {
        ...
        serviceHostProxy.getScriptSnapshot = (filename) => {
            ...
            //
                ...
                console.log('🚀 ~ file: plugin.ts:283 ~ create ~ has priorSnapshot:', !!priorSnapshot);
                ...
                console.log('🚀 ~ file: plugin.ts:293 ~ getScriptSnapshot ~ hasSegments:', hasSegments, JSON.stringify(originalText), { main, segments });
